...
- 2025-11-14: Pendente migrar o fluxo da “Ferramenta completa de PDF” (`src/pages/pdf-multi-tool.html` + `src/js/logic/pdf-multi-tool.ts`) para o catálogo i18n; o HTML/JS ainda possui strings fixas em português e precisa ser alinhado antes da migração para React.
