...
import { setupPdfToJsonPage } from '../../../js/logic/pdf-to-json.js';

export const PdfToJsonTool = () => {
  useEffect(() => {
    const teardown = setupPdfToJsonPage();
    return () => {
  ...
  return (
    <section className="py-4">
      <div className="bg-gray-800 rounded-xl shadow-xl p-8 text-gray-200 border border-gray-700">
        <h2 className="text-2xl font-bold text-white mb-2">Converter PDF em JSON</h2>
        <p className="text-gray-400 mb-6">
          Envie vários PDFs para convertê-los em JSON. Os dados exportados são entregues em um arquivo ZIP.
        </p>
        ...
        <div className="upload-section mb-6">
          <div className="relative flex flex-col items-center justify-center w-full h-48 border-2 border-dashed border-gray-600 rounded-xl cursor-pointer bg-gray-700 hover:bg-gray-600 transition-colors duration-300">
            <div className="flex flex-col items-center justify-center pt-5 pb-6">
              ...
              <p className="text-xs text-gray-500">Aceita múltiplos arquivos PDF</p>
